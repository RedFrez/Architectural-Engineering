...
label_v = {'Hack', 18};
%
colVal = {[(33/255) (150/255) (243/255)],...
         [(227/255) (29/255) (12/255)],...
         [(255/255) (193/255) (7/255)]};
scrsz = get(groot, 'ScreenSize');
% set up figure
figure('Position', [.5*scrsz(3), .25*scrsz(4), 1000, 600]);
tl = tiledlayout(2,1);
...
hold on
for n = 1:modes
   plot(pltqt, t, mode(n).q, 'LineWidth', plot_l, 'Color', colVal{(n)});
end
...
hold on
for d = 1:dof
    plot(pltut, t, mode(d).u, 'LineWidth', plot_l, 'Color', colVal{(d)});
end
...
t2.Padding = 'compact';
title(t2, 'Modal Analysis of Northridge Earthquake', title_n, title_v);
...
% hold on
% for d = 1:dof
%     plot(pltsap, t, mode(d).u, 'LineStyle', '--', 'LineWidth', plot_l, 'Color', colVal{(d)});
% end
% hold off
% xlim([3.5 10.5]);
% ylim([-3 3]);
